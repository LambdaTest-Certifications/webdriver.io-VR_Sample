...
const USERNAME = process.env.LT_USERNAME || "lakshaysaini";

// AccessKey:  AccessKey can be generated from automation dashboard or profile section
const KEY = process.env.LT_ACCESS_KEY || "V3KOFXNCwt2RtHd0GGLT0d6zGyFJY084XwOHbTKTJ0YdszSqwI";
...
async function searchTextOnGoogle() {
  ...
  let capabilities = {
    ...
    "user": USERNAME,
    "accessKey": KEY,
    name: "Tool", // name of the test
    build: platform + browserName + version, // name of the build
    "smartUI.project": "Sample",
  ...
  await driver
    ...
    .then(function () {
      ...
      driver.getTitle().then(function (title) {
        setTimeout(function () {
          driver.executeScript("lambda-status=je baat");
          driver.quit();
        }, 15000);
      });
    })
    .catch(function (err) {
      ...
      driver.executeScript("lambda-status=tumse na hopayga");
      driver.quit();
    });
}
